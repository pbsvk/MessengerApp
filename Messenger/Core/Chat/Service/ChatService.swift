...
struct ChatService {
    ...
    let chatPartner: User
     ...
     func sendMessage(_ messagetext:String){
         ...
         let recentCurrentUserRef = FirestoreConstants.MessageCollection.document(currentUid).collection("recent-mesages").document(chatPartnerId)
         let recentPartnerRef = FirestoreConstants.MessageCollection.document(chatPartnerId).collection("recent-mesages").document(currentUid)
